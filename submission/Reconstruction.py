...
if __name__ == '__main__':
    ...
    # mutations and floating shells are visible
    # file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.5, polyharmonic, -1
    # fine
    # file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.05, biharmonic, -1
    # mutation and attached shell visible
    file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.5, biharmonic, -1
    # almost compeletely surrounded by a floating shell
    # file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.05, partial(Wendland, beta=0.5), -1
    # fine, we got rid of the shell by lowering beta
    # file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.05, partial(Wendland, beta=0.2), -1
    # floating islands, because we have shortened the locality of the RBF, we now get the same shell as in the first Wendland attempt
    # file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.05, partial(Wendland, beta=0.8), -1

    # l=1 degree polynomial has treated the shell for Wendland with beta=0.5
    # file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.05, partial(Wendland, beta=0.5), 1

    # file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.05, partial(Wendland, beta=0.5), 1
    # file_name, epsilon, RBF_function, l = 'dragon-3000.off', 0.05, partial(Wendland, beta=0.5), 1
    ...
    # file_name, epsilon, RBF_function, l = 'bunny-500.off', 0.1, partial(Wendland, beta=0.6), -1
    ...
    w, RBF_centers, a = compute_RBF_weights(inputPoints, inputNormals, RBF_function, epsilon, l=l, sparsify=sparsify)
    ##
    ##
